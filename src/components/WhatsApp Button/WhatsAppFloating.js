...
function WhatsAppFloating() {
  ...
  return (
    <div className="hidden md:block">
      <a href="https://wa.me/56936354209?text=Hola,%20quisiera%20agendar%20una%20hora." className="fixed bottom-11 right-28 opacity-80 bg-slate-600 dark:bg-slate-200 px-2 py-1 text-xs">
      ...
      <div className="w-4  overflow-hidden fixed bottom-3 right-24 opacity-80">
        <div className=" h-16  bg-slate-600 dark:bg-slate-200 rotate-45 transform origin-top-left"></div>
      </div>
